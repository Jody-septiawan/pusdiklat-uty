            ...
            <div class="card-header bg-primary border-bottom-warning py-2">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <button class="btn btn-success py-0" data-toggle="modal" data-target="#newMenu">Tambah prodi</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            foreach ($prodi as $m) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('kelola_web/editprodi/') . $m['id']; ?>"><i class="fa fa-edit text-light mx-0 rounded-circle py-2 pl-2 pr-2 bg-success icon-kelas"></i></span></a>
                                        <a href="<?= base_url('kelola_web/deleteprodi/') . $m['id']; ?>" class="tombol-delete-prodi"><i class="fa fa-trash text-light mx-0 rounded-circle py-2 px-2 bg-danger icon-kelas"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
